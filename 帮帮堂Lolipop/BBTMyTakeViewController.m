...
#import "BBTMyTakeViewController.h"
#import "BBTTaskViewController.h"
#import <AVOSCloud.h>

@interface BBTMyTakeViewController ()

@end

@implementation BBTMyTakeViewController
...
- (void)viewDidLoad {
    ...
    [query whereKey:@"taskReceiver" equalTo:currentUser.objectId];
